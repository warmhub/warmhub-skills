    ...
    "assertionModel": [
      {
        ...
        "aboutCardinality": "single | pair | set | list",
...
- Relationship assertions use Pair, Set, or List when a single target would hide an endpoint (use a named domain shape for a genuine ternary relationship).
